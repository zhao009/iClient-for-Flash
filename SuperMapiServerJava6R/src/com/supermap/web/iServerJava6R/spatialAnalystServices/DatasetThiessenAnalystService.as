package com.supermap.web.iServerJava6R.spatialAnalystServices
{
	...
	/**
	 * ${iServerJava6R_DatasetThiessenService_Title}.
	 * <p>${iServerJava6R_DatasetThiessenService_Description}</p> 
	 * 
	 */	
	public class DatasetThiessenAnalystService extends ServiceBase
	{
		private var _lastResult:ThiessenAnalystResult;
		
		/**
		 * ${iServerJava6R_DatasetThiessenService_constructor_overloads_D} 
		 * @param url ${iServerJava6R_DatasetThiessenService_constructor_param_url}
		 * 
		 */	
		override public function DatasetThiessenAnalystService(url:String)
		{
			super(url);
		}
		
		/**
		 * ${iServerJava6R_DatasetThiessenService_method_ProcessAsync_D}.
		 * <p>${iServerJava6R_DatasetThiessenService_method_ProcessAsync_remarks}</p> 
		 * @param parameters ${iServerJava6R_DatasetThiessenService_method_ProcessAsync_param_parameters}
		 * @param responder ${iServerJava6R_DatasetThiessenService_method_ProcessAsync_param_IResponder}
		 * @return ${iServerJava6R_DatasetThiessenService_method_ProcessAsync_return}
		 * 
		 */	
		public function processAsync(parameters:DatasetThiessenAnalystParameters, responder:IResponder = null):AsyncToken
		{
			...
			var extendURL:String = "datasets/" + parameters.dataset + "/thiessenpolygon.json?returnContent=true&X-RequestEntity-ContentType=application/flex&debug=true";
