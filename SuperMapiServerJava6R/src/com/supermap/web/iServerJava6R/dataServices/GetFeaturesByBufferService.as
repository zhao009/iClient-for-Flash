package com.supermap.web.iServerJava6R.dataServices
{
	...
	/**
	 * ${iServerJava6R_GetFeaturesByBufferService_Title}.
	 * <p>${iServerJava6R_GetFeaturesByBufferService_Description}</p> 
	 * 
	 */	
	public class GetFeaturesByBufferService extends ServiceBase
	{
		/**
		 * ${iServerJava6R_GetFeaturesByBufferService_constructor_D} 
		 * @param url ${iServerJava6R_GetFeaturesByBufferService_constructor_param_url}
		 */		
		override public function GetFeaturesByBufferService(url:String)
		{
			super(url);
		}
		...
		/**
		 * ${iServerJava6R_GetFeaturesByBufferService_method_ProcessAsync_D}.
		 * <p>${iServerJava6R_GetFeaturesByBufferService_method_ProcessAsync_remarks}</p> 
		 * @param parameters ${iServerJava6R_GetFeaturesByBufferService_method_ProcessAsync_param_parameters}
		 * @param responder ${iServerJava6R_GetFeaturesByBufferService_method_ProcessAsync_param_IResponder}
		 * @return ${iServerJava6R_GetFeaturesByBufferService_method_ProcessAsync_return}
		 * 
		 */		
		public function processAsync(parameters:GetFeaturesByBufferParameters, responder:IResponder = null):AsyncToken
		{	
			if(!parameters)
			{
		...
		private function getVariables(parameters:GetFeaturesByBufferParameters):String
		{
			var postJson:String = "";
			if(parameters.attributeFilter == null)
			{
				postJson = '{\"getFeatureMode\":\"BUFFER\",\"datasetNames\":';
			}
			else
			{
				postJson = '{\"getFeatureMode\":\"BUFFER_ATTRIBUTEFILTER\", \"attributeFilter\":\"' + parameters.attributeFilter + '\",\"datasetNames\":';
			}
			...
			{
				postJson += (',\"bufferDistance\":' + parameters.bufferDistance);
			}
