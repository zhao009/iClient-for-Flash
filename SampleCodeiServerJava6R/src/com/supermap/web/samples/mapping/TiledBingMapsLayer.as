...
{	
	...
	public class TiledBingMapsLayer extends TiledCachedLayer
	{
		...
		private const ROAD_URL:String = "http://r{subdomain}.tiles.ditu.live.com/tiles/r{quadkey}.png?g=91&mkt=zh-Hans&shading=hill";
		...
		public function TiledBingMapsLayer(mapType:String = "road")
		{
			...
			this.CRS = new CoordinateReferenceSystem(102100,Unit.METER);
			this.buildTileInfo();
