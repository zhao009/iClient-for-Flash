...
{   
	...
	public class ElementsLayer extends Layer
	{
		 ...
		 * 
		 */		
		public function addComponent(component:UIComponent, bBox:Rectangle2D, offset:Point = null):String
		{   
			try{
		 ...
		 * 
		 */		  
		public function addComponentAt(component:UIComponent, index:int, bBox:Rectangle2D, offset:Point = null):String
		{
...
//				this.hashTableIDs.clear();
		...
		{
			return this.getComponentIndex(element.component);
		}
		
		private function getComponentIndex(component:DisplayObject):int
		{
			for(var i:int; i < this._elements.length; i++)
			{
				if(component == (this._elements[i] as Element).component)
				{
					return i;
				}
			}
