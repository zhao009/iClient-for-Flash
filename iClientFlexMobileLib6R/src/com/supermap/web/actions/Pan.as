package com.supermap.web.actions
{
	...
	public class Pan extends MapAction
	{
		...
		private function enterFrameHandler(event:Event) : void
		{
			...
			//trace("移动前：","offsetX",offsetX,"offsetY",offsetY);
			...
			{		
				...
				//trace("移动：","offsetX",offsetX,"offsetY",offsetY);			
				this._scrollRectX += offsetX;
				this._scrollRectY += offsetY;							
				//trace("this._scrollRectX",this._scrollRectX,"this._scrollRectY",this._scrollRectY);
