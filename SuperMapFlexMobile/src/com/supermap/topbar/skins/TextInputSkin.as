...
package com.supermap.topbar.skins
{
	import com.supermap.topbar.skins.TextInputSkin_Border;
	...
	public class TextInputSkin extends TextSkinBase 
	{
		...
		public function TextInputSkin()
		{
			...
			borderClass = TextInputSkin_Border;
		...
		protected var _searchIcon:Image;
		...
		override protected function createChildren():void
		{
			...
			_searchIcon.source = new icon();
			_searchIcon.width = 24;
			_searchIcon.height = 24;
			_searchIcon.x = 3;
			_searchIcon.y = 5;
												   ...
												   unscaledHeight:Number):void
		{
			...
			if(_searchIcon)
			{
				setElementSize(_searchIcon, 24, 24);
				setElementPosition(_searchIcon, 3, 5);
			}
			...
			if (textDisplay)
			{
				...
				setElementSize(textDisplay, unscaledWidth - 24, adjustedTextHeight);
				
				// set x=0 since we're using textDisplay.leftMargin = paddingLeft
				setElementPosition(textDisplay, 24, textY);
			}
