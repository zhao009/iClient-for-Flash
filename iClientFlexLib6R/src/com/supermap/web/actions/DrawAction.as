package com.supermap.web.actions
{
	...
	public class DrawAction extends MapAction
	{
		...
		/**
		 * ${actions_DrawAction_attribute_snap_D} 
		 * @return 
		 * 
		 */
		...
		protected function endDraw(endPoint:Point2D = null) : void
		{
			if(this.tempFeature)
			{
				//?this.tempFeature.geometry.clone():null
				this.drawFeature  = new Feature(this.tempFeature.geometry, this.tempFeature.style?this.tempFeature.style.clone():null);
