package com.supermap.web.actions
{
	...
	public class DrawPoint extends Pan
	{
		...
		//覆盖pan父类的onMouseOver和onMouseOut方法 ，鼠标移出时删除样式，移入时重新加入样式
		/**
		 * @inheritDoc 
		 * @param event
		 * 
		...
		override protected function onMouseOver(event:MouseEvent) : void {
			...
			{
				this._cursorID = this.map.cursorManager.setCursor(_cursorClass, CursorManagerPriority.LOW, this._cursorXOffset, this._cursorYOffset); 
