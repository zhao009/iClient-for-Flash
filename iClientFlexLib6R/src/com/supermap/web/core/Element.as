...
{	
	...
	public class Element
	{
		...
		private var _originalBounds:Rectangle2D;
...
//		}
		...
		public function Element(component:DisplayObject = null, bounds:Rectangle2D = null)
		{
			...
			this._bounds = bounds;  
			if(bounds!=null)this._originalBounds = bounds.clone();
		...
		public function set component(elementObj:DisplayObject):void
		{
...
//			this.needUpdate = false;
		...
		/**
		 * ${core_Element_attribute_originalBounds_D}.
		 * @return 
		 * 
		 */	
