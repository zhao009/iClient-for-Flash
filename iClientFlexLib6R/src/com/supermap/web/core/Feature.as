package com.supermap.web.core
{
	...
	import com.supermap.web.components.IFeatureRenderer;
	 ...
	 * @see #style
	 * @see com.supermap.web.mapping.FeaturesLayer#renderer
	 * @see com.supermap.web.mapping.FeaturesLayer#style
	 * @see com.supermap.web.core.geometry.Geometry#defaultStyle
	 * 
	 * 
	 */	
	public class Feature extends UIComponent
	{
		...
		//用于网格记录它包含的所有点
		private var _childFeatrues:ArrayCollection = new ArrayCollection();
		//用于网格计算label时需要临时
		...
		sm_internal function get target():Object
		{
			return _target;
		}
		
		sm_internal function set target(value:Object):void
		{
			_target = value;
		}
		
		sm_internal function set childFeatrues(vaule:ArrayCollection):void
		{
			_childFeatrues = vaule;
		}
		sm_internal function get childFeatrues():ArrayCollection
		{
			return _childFeatrues;
		}
