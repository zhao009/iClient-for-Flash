package com.supermap.web.iServerJava2.networkAnalystServices
{
	...
	/**
	 * ${iServer2_networkAnalystServices_FindTSPPathService_Title}.
	 * <p>${iServer2_networkAnalystServices_FindTSPPathService_Description}</p>
	 * @see NetworkAnalystResult
	 * @see TSPPathParam#isEndNodeAssigned
	 * 
	 * 
	 */
	public class FindTSPPathService extends ServiceBase
	{
		private var _lastResult:NetworkAnalystResult;
		
		/**
		 * ${iServer2_networkAnalystServices_FindTSPPathService_constructor_String_D}
		 * @param url ${iServer2_networkAnalystServices_FindTSPPathService_constructor_String_param_url}
		 * 
		 */
		...
		/**
		 * ${iServer2_networkAnalystServices_FindTSPPathService_attribute_lastResult_D}
		 * 
		 */
		...
		/**
		 * ${iServer2_networkAnalystServices_FindTSPPathService_method_execute_D}
		 * @param responder ${iServer2_networkAnalystServices_FindTSPPathService_method_execute_param_responder}
		 * @param parameters ${iServer2_networkAnalystServices_FindTSPPathService_method_execute_param_parameters}
		 * @return ${iServer2_networkAnalystServices_FindTSPPathService_method_ProcessAsync_return}
		 * 
		 */
		public function execute(responder:IResponder, parameters:FindTSPPathParameters):AsyncToken
		{
            ...
            reqVar.method = "FindTSPPath";
            reqVar.params = "<uis>" + 
            		"<command>" + 
            			"<name>FindTSPPath</name>" +
            			"<parameter>" +
	            			"<mapName>" + parameters.mapName + "</mapName>" + 
	            			"<networkSetting>" + parameters.networkSetting.toJson() + "</networkSetting>" +
	            			"<tspPathParam>" + parameters.tspPathParam.toJson() + "</tspPathParam>" +
